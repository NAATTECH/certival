    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    UserManager.AddToRole(user.Id, "UsuarioRegistrado");
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirma tu cuenta", ParserUtility.RenderRazorViewToString(this, "_PartialEmailConfirm",new { callbackUrl = callbackUrl}));
